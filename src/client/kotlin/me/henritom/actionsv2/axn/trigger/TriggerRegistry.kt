...
object TriggerRegistry {
    ...
    fun initTypes() {
        ...
        TriggerType("keybind", "Triggers, when a keybind is pressed.",
            listOf(
                TriggerSetting("key", "The key to watch for.", "string"),
                TriggerSetting("action", "The action to perform when the key is pressed.", "list(press,release)", "press")
            )
        )
        ...
        TriggerType("region_update", "Triggers, when the region is updated.",
            listOf(
                ...
                TriggerSetting("type", "The type of the region update.", "list(enter,leave)", "enter", true)
            )
        )
