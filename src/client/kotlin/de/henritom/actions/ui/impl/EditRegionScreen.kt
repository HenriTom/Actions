...
class EditRegionScreen(val parent: Screen?) : Screen(Text.translatable("actions.ui.addregion.title")) {
    ...
    private var updateButton: ButtonWidget? = null

    private var region: Region? = null

    fun asRegion(region: Region): EditRegionScreen {
        this.region = region
        return this
    }
    ...
    override fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        if (pos1X == null) {
            ...
            pos1X?.text = region?.pos1?.x?.toInt().toString()
        ...
        if (pos1Y == null) {
            ...
            pos1Y?.text = region?.pos1?.y?.toInt().toString()
        ...
        if (pos1Z == null) {
            ...
            pos1Z?.text = region?.pos1?.z?.toInt().toString()
        ...
        if (pos2X == null) {
            ...
            pos2X?.text = region?.pos2?.x?.toInt().toString()
        ...
        if (pos2Y == null) {
            ...
            pos2Y?.text = region?.pos2?.y?.toInt().toString()
        ...
        if (pos2Z == null) {
            ...
            pos2Z?.text = region?.pos2?.z?.toInt().toString()
        ...
        if (updateButton == null) {
            updateButton = ButtonWidget.builder(Text.translatable("actions.ui.editregion.update")) {
